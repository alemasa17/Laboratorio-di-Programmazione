...
Transazione trans("2025-03-01", "Deposito", 100.0, "In", "Mittente");
conto.addTransazione(trans);

EXPECT_EQ(conto.getSaldo(), 100.0);
}
...
Transazione transIn("2025-03-01", "Deposito", 100.0, "In", "Mittente");
Transazione transOut("2025-03-02", "Prelievo", 50.0, "Out", "Ricevente");
